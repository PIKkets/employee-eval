...
CREATE TABLE dbo.DEPARTMENT (
    ...
    CONSTRAINT FK_DEPT_PARENT FOREIGN KEY (parent_id) REFERENCES dbo.DEPARTMENT(id)
);
...
CREATE TABLE dbo.EVALUATION_TYPE_WEIGHT (
    eval_type NVARCHAR(20) PRIMARY KEY,
    weight    INT NOT NULL
);

ALTER TABLE dbo.DEPARTMENT ADD CONSTRAINT FK_DEPT_HEAD FOREIGN KEY (head_id) REFERENCES dbo.EMPLOYEE(id);
